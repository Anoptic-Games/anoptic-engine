...
static const AnoAudioOfflineEvent k_events[] = {
    { .frame = 0, .cmd = { .kind = ACMD_BUS_SET, .bus = 1,
        .fields = ANO_AUDIO_FIELD_GAIN | ANO_AUDIO_FIELD_CUTOFF | ANO_AUDIO_FIELD_Q
                | ANO_AUDIO_FIELD_FILTER_MODE,
        .gain = 0.9f, .cutoffHz = 8000.0f, .q = 0.9f, .filterMode = ANO_AUDIO_FILTER_LOWPASS } },
    ...
    { .frame = 6000, .cmd = { .kind = ACMD_BUS_SET, .bus = 1,
        .fields = ANO_AUDIO_FIELD_CUTOFF, .cutoffHz = 1200.0f } },
    ...
    { .frame = 24000, .cmd = { .kind = ACMD_BUS_SET, .bus = 1,
        .fields = ANO_AUDIO_FIELD_CUTOFF, .cutoffHz = 9000.0f } },
