...
// Averaged per-pass GPU times + per-allocator VRAM. res= = realized swapchain extent.
...
// Drain one ANO_PERF_WINDOW_FRAMES window: [frame] fps/mean, [frametime] percentiles, then reset.
