...
// Grow every slot-indexed GPU buffer to hold >= required slots. False on OOM, with buffers,
// capacities and descriptor sets left exactly as they were: a refused growth publishes nothing.
