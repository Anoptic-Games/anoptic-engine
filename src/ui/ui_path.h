...
// ANO_UI_CURVE_SENTINEL is public ABI, identical to ANO_TEXT_POINT_SENTINEL.
...
// Split quad at interior per-axis extrema into 1..3 monotone pieces. Returns count.
// Defined in src/text/text_bake.c.
