...
for shader in flat.mesh flat.vert flat.frag transmission.frag additive.frag cull.comp tpsort.comp update.comp scatter.comp lightcull.comp shadowsetup.comp shadow_depth.frag shadowblur.frag tonemap.vert tonemap.frag; do
