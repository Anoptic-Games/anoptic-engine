...
Status: this is the sole current completion specification for the Anoptic resource manager. `docs/resourcemanager-real.md` preserves the owner's directives and the superseded plan, `RESOURCE_MANAGER_IMPL.md` preserves implementation chronology rather than specification authority, and `docs/resourcemgr/` contains historical research and planning.
