# 2026-07-30 C+Ultra FPS root-cause run: rootcause-2560-13-reference-telemetry
...
- Harness: `tools/perf/bench_fps_win64.py --res 2560x1440`, 30 s, 2 s warmup dropped, fresh process, foreground verified. External NVIDIA/WDDM counters were observational only.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 2560x1440 | 642.3 | 686.1 | 447.8 | 436.7 | 2.889 | 0.944 | 1059 | 0.65 | 8.0 | CPU/present |
