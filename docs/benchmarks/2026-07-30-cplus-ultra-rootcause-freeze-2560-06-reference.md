# 2026-07-30 C+Ultra FPS root-cause run: rootcause-freeze-2560-06-reference
...
- Scene: Sponza, viking room, candles, SHADOWMAP, 0.0 of 42 shadow frusta per frame, HUD menu open.
- Harness: `tools/perf/bench_fps_win64.py --res 2560x1440`, 30 s, 2 s warmup dropped, fresh process, foreground verified.

ENV_VARS: ANO_SHADOW_BUDGET=2, ANO_SHADOW_CACHE_FREEZE=1
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 2560x1440 | 642.3 | 770.6 | 475.5 | 465.4 | 2.620 | 0.819 | 1221 | 0.64 | 0.0 | CPU/present |
