# 2026-07-29 hyper-C++ empty-scene baseline
...
- Engine: Anoptic at commit e2dbe3b84283bd250731eb3a94baad68046fae1c (branch codex/hyper-c-codegen)
...
- Scene: Empty fallback scene because ignored demo assets were absent from the new Git worktree; SHADOWMAP, 8 of 42 shadow frusta per frame, HUD menu open
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1920x1080 | 360.1 | 1251.1 | 612.4 | 564.7 | 3.694 | 0.365 | 2740 | 0.46 | 8.0 | CPU/present |

All rows foreground-verified. This run is recorded unconditionally per the benchmark procedure but excluded from the final code comparison because the new worktree did not inherit the repository-ignored demo assets.
