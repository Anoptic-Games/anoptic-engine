# 2026-07-30 C+Ultra FPS root-cause run: rootcause-orbit-2560-reference-45s
...
- Harness: `tools/perf/bench_fps_win64.py --res 2560x1440`, 45 s, 2 s warmup dropped, fresh process, foreground verified.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 2560x1440 | 642.3 | 686.5 | 449.2 | 436.9 | 2.849 | 0.946 | 1057 | 0.65 | 8.0 | CPU/present |
