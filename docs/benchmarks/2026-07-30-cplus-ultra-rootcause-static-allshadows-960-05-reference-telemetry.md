# 2026-07-30 C+Ultra FPS root-cause run: rootcause-static-allshadows-960-05-reference-telemetry
...
- Harness: `tools/perf/bench_fps_win64.py --res 960x540`, 30 s, 2 s warmup dropped, fresh process, foreground verified. External NVIDIA/WDDM counters were observational only.

ENV_VARS: ANO_FORCE_NO_SHADOW_CACHE=1, ANO_SHADOW_BUDGET=2
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 960x540 | 97.6 | 759.8 | 468.9 | 458.5 | 2.960 | 0.820 | 1220 | 0.63 | 26.0 | CPU/present |
