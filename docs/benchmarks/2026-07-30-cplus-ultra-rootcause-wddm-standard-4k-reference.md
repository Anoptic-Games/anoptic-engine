# 2026-07-30 C+Ultra FPS root-cause run: rootcause-wddm-standard-4k-reference
...
- Harness: `tools/perf/bench_fps_win64.py --res 3840x2160`, 30 s, 2 s warmup dropped, fresh process, foreground verified. External NVIDIA/WDDM counters were observational only.
...
Borderless windowed physical-pixel client area; per-monitor-v2 DPI aware. The 3840x2160 target realized 3840x2160.

## Results

| res | swap MiB | wall fps | 1% low | 0.1% low | max ms | GPU ms | GPU cap | wall/cap | frusta | bound |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 3840x2160 | 1406.3 | 590.9 | 500.3 | 486.1 | 3.305 | 1.653 | 605 | 0.98 | 8.0 | GPU |

The row was foreground-verified. Swap allocation is 169.5 MiB/MP at the realized extent, consistent with the established allocation scale.
