...
| **tension** | 0 … 1 | unresolvedness, suspense (*calm-but-tense exists*) |
...
&gt; 0.12, melody &gt; 0.28, percussion &gt; 0.34, arp &gt; 0.62 (top tier; dramaturg can hold it hostage, §9.4). Instrument
...
mixolydian +1, dorian 0, aeolian −1, phrygian −2. Locrian is left out on purpose.**
The control layer may only select from these six. Valence maps
...
spend, payoff ≥ 0.7): parallel-mode brightening that makes the payoff
glow.
...
new colors; valence recolors a piece without rewriting it. The vocabulary: triads and stacked-third
...
No general 2/bar. Cadence-approach acceleration elsewhere remains the three-bar cadential 6/4 formula. *"Generalizing to arbitrary 2/bar would mean
...
cadence approach, which the timeline already covers."*
...
(the three-bar form stands down). **Bass needs nothing** (the dominant pitch pervades both
...
tempo.** A dramaturg spend deepens the breath
...
- **Elision**: a high-energy phrase (energy ≥ 0.75) promising an authentic
  ...
  departure."* The shared bar's chord is **forced to I** (one bar serves as both resolution and opening)
  and it carries the
...
- **The pickup**: on a cadence bar, a 1–3-note stepwise run of 8ths may lead
  into the next phrase, ending **on the next chord's third** (sweet
...
of what sounds. Adjacent functional chords share or step between their
...
- **Kick**: Euclidean E(k, slots) with k scaled by density (2–5 in 4/4). In
  ...
  shuffle 8th and a pre-downbeat pickup as density rises). Euclidean
